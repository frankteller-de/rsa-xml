...
/**
 * @param container Make sure to specify a container name as well if you're providing key
 */
export default (key?: string, container?: string) => new RSAXML(key, container);
